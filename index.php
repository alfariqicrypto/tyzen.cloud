...
<head>
    ...
    <link rel="icon" href="images/tyzen-ico.ico"/>
    
    <meta name="title" content="Tyzen are Secure Blockchain Cryptocurrency Assets">
    <meta name="description" content="Peer to peer cryptocurrency for your future investment like Bitcoin with better transaction speed and smaller fees.">
    <meta name="keywords" content="tyzen, tyzen coin, tyzen blockchain, tyzen token, cryptocurrency, tyzen wallet, tyzen mining, tyzen mining pool, tyzen explorer, tyzen exchange, tyzen price">
    <meta name="robots" content="index, follow">
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://www.tyzen.io/">
    <meta property="og:title" content="Tyzen are Secure Blockchain Cryptocurrency Assets">
    <meta property="og:description" content="Peer to peer cryptocurrency for your future investment like Bitcoin with better transaction speed and smaller fees.">
    <meta property="og:image" content="images/opengraph.png">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://www.tyzen.io/">
    <meta property="twitter:title" content="Tyzen are Secure Blockchain Cryptocurrency Assets">
    <meta property="twitter:description" content="Peer to peer cryptocurrency for your future investment like Bitcoin with better transaction speed and smaller fees.">
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2250175894500482"
        ...
        <div class="container">
            <div class="main-menu-wrapper bg-transparent rounded-0 p-0">
                <div class="row align-items-center">
                    <div class="col-lg-2">
                        <a href="https://www.tyzen.io" class="main-logo">
                            <img class="sticky-logo-hide" src="images/tyzen-white.png" style=" width:130;height:37;" alt="Tyzen logo">
                            <img class="sticky-logo-show" src="images/tyzen-black.png" style=" width:130;height:37;" alt="Tyzen logo">
                        </a>
                    </div>
                    <div class="col-lg-10">
                        <div class="main-navbar d-flex align-items-center justify-content-between">
                            <nav class="main-nav main-nav-white text-capitalize main-nav-2">
                                <ul>
                                    ...
                                    <li>
                                        <a href="https://opensea.io/collection/tyzen-coin" target="_blank">NFT <i class="font-size-12"></i></a>
                                    </li>
                                     <li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="drop-menu">
                                            ...
                                            <li><a href="https://bscscan.com/address/0x524dc4b2db22761bf4df9cecf5f25890865c086d">Pre-Sale</a></li>
                            ...
                            <div class="navbar-toolbar d-flex align-items-center">
                                <ul class="list-items list-items-white">
                                    <li class="d-inline-block"><a href="https://discord.gg/tyzen" class="btn btn-sm btn-light text-black">Join Community</a></li>
                                </ul>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card hover-y">
                    <div class="card-body position-relative">
                        ...
                        <a href="https://www.tyzen.io/downloads/tyzen-1.0.0/Tyzen Core-1.0.0-win64-setup-installer.exe" class="btn-link">Setup Download <i class="fa fa-cloud-download"></i></a>
                        <p><a href="https://www.tyzen.io/downloads/tyzen-1.0.0/Tyzen Core-1.0.0-win64.zip" class="btn-link">Normal Download <i class="fa fa-cloud-download"></i></a></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="card hover-y">
                    <div class="card-body position-relative">
                        ...
                        <a href="https://www.tyzen.io/downloads/tyzen-1.0.0/tyzen-1.0.0-x86_64-linux-gnu-18.04.tar.gz" class="btn-link">Download <i class="fa fa-cloud-download"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="card hover-y">
                    <div class="card-body position-relative">
                        ...
                        <p class="card-desc mb-3">Github stagging tree of Tyzen Blockchain, for complining from source code are avaible for public</p>
                        <a href="https://github.com/tyzen-tzn/tyzen" target="_blank" class="btn-link">Check Github <i class="fa fa-external-link"></i></a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="client-logo-area section-padding position-relative">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5">
                <h2 class="sec-title mb-4 mb-lg-0"><span class="underline-shape">Discover</span> more on these trusted websites</h2>
            </div><!-- end col-lg-6 -->
            <div class="col-lg-7">
                <div class="client-logo-carousel-2 owl-carousel">
                    ...
                    <div class="client-logo-item d-inline-block">
                        <img src="https://i.ibb.co/PDKRrFh/500x500-4-pbcywich537nkvulnttqgjo1t3zn4ho3kushy7on2o.png" alt="blockspot">
                    </div><!-- end client-logo-item -->
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-item mb-5">
                    ...
                    <ul class="list-items pt-4">
                        <li class="mb-3"><a href="mailto:supports@tyzen.io"><i class="fa fa-envelope font-size-14"></i> supports@tyzen.io</a></li>
                        <li class="mb-3"><i class="fa fa-globe font-size-14"></i> Bali, Indonesia</li>
                        <li class="mb-3"><i class="fa fa-clock-o font-size-14"></i> Mon-Sat 08AM - 05PM</li>
                    </ul>
                    <div class="social-icons">
                        <a href="https://twitter.com/TyzenIo" target="_blank" class="icon-element icon-element-sm mr-1"><i class="fa fa-twitter"></i></a>
                        <a href="https://bitcointalk.org/index.php?topic=5404159.0" target="_blank" class="icon-element icon-element-sm mr-1"><i class="fa fa-bitcoin"></i></a>
                        <a href="https://www.reddit.com/r/tyzen/" target="_blank" class="icon-element icon-element-sm mr-1"><i class="fa fa-reddit"></i></a>
                        <a href="https://www.youtube.com/channel/UCgTpiS9mqkkRqrT_iBnQ17w" target="_blank" class="icon-element icon-element-sm mr-1"><i class="fa fa-youtube"></i></a>
                        <a href="https://github.com/tyzen-tzn" target="_blank" class="icon-element icon-element-sm mr-1"><i class="fa fa-github"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-item mb-5">
                    ...
                    <ul class="list-items list-items-hover pt-4">
                        ...
                        <li class="mb-2"><a href="https://t.me/swtyzen" target="_blank">Telegram Supports</a></li>
                        <li class="mb-2"><a href="https://discord.gg/tyzen">Discord Support</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
